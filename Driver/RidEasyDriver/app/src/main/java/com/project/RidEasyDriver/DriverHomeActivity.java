...
import com.project.RidEasyDriver.Utils.UserUtils;
import com.project.RidEasyDriver.databinding.ActivityDriverHomeBinding;
...
public class DriverHomeActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        DatabaseReference mDatabaseReference = FirebaseDatabase.getInstance().getReference().child("InfoDriver").child(userId);
